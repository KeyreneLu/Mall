				...
				<div class="col-md-10">
					...
					<c:forEach items="${HotProductList}" var="hotProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<p><a href="/productinfo?pid=${hotProduct.pid}" style='color:#666'>${hotProduct.pname}</a></p>
							<p><font color="#E4393C" style="font-size:16px">商城价：${hotProduct.shopPrice}</font></p>
						</div>
					</c:forEach>
				</div>
			</div>
				...
				<div class="col-md-10">
					...
					<c:forEach items="${NewProductList}" var="newProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<p><a href="/productinfo?pid=${newProduct.pid}" style='color:#666'>${newProduct.pname}</a></p>
							<p><font color="#E4393C" style="font-size:16px">商城价：${newProduct.shopPrice}</font></p>
						</div>
					</c:forEach>
				</div>
			</div>			
