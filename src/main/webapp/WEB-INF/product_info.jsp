...
<script type="text/javascript">
	function addShopCart() {
		...
		location.href = "/addcart?pid=${product.pid}&&buyNum="+quantity;
    }
</script>
</head>
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:void(0);" onclick="addShopCart()"> <input style="background: url('images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;"
					...
					<div style="margin: 10px 0 10px 0;">
						<a href="/list?categoryid=${cid}&&currentPage=${currentPage}"> &nbsp;返回列表页面</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
